...
Patch5:            0006-Init-openssl-engine-properly.patch

# downstream patch for RHEL - https://bugzilla.redhat.com/show_bug.cgi?id=1955564
Patch6:            0007-Support-loading-cert-hardware-token-PKC.patch
...
Patch15:           0016-Rewrite-fix-buffer-overflow-with-overlapping-capture.patch
...
Patch16:           0017-Added-max_headers-directive.patch
...
# https://redhat.atlassian.net/browse/RHEL-212459
# upstream patches:
...
Patch20:           0021-Script-access-log-buffer-overrun-protection-ABI-safe.patch
...
* Tue Sep 08 2026 Luboš Uhliarik <luhliari@redhat.com> - 2:1.26.3-14
...
* Mon Jun 08 2026 Luboš Uhliarik <luhliari@redhat.com> - 2:1.26.3-11
- nginx:1.26/nginx: HTTP/2: Remote Denial of Service via compression bomb
  and Slowloris-style attack

* Mon Jun 08 2026 Luboš Uhliarik <luhliari@redhat.com> - 2:1.26.3-10
...
* Mon Jan 20 2025 Luboš Uhliarik <luhliari@redhat.com> - 2:1.26.2-3
- Fix PKCS-11 support

* Sun Jan 05 2025 Luboš Uhliarik <luhliari@redhat.com> - 2:1.26.2-2
- Adjust QE files
